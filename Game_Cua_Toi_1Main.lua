...
do
-- Merged into the existing WindUI main window
...
-- Dùng chung cửa sổ WindUI của Main duy nhất
local Window = iData.value12.Window
local VxzSection = Window:Section({
    Title = "VXZ",
    Opened = true,
})

local MainTab = VxzSection:Tab({
    Title = "Main",
    Icon = "home"
})
...
local SecurityTab = VxzSection:Tab({
